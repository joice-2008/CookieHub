...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/cadUsuario.css') ?>">
</head>
<body>
    <?= $this->include('menu') ?>
        ...
        <div class="dados-usuario">
            ...
            <div class="cabecalho-perfil">
                ...
                <div class="avatar-perfil">
                    <?= mb_strtoupper(mb_substr(esc($nomeUsuario), 0, 1)) ?>
                </div>
 
                <div class="info-perfil">
                    <div class="linha-nome">
                        <div>
                            <h1 class="mensagem-perfil"><?= esc($nomeUsuario) ?></h1>
                            <h2 class="username-perfil">@<?= esc($loginUsuario) ?></h2>
                        </div>
 
                    </div>
 
                    <div class="quantidade-receitas">
                        <?= count($receitas) ?> <?= count($receitas) == 1 ? 'receita cadastrada' : 'receitas cadastradas' ?>
                    </div>
                </div>
