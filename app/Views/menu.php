...
<body>
    <div class="container">
        ...
        <div class="grupo2">
            <div class="grupoPesquisa">
                <input type="text" name="pesquisa" id="pesquisa" placeholder="Buscar receitas...">
            </div>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu menu-custom">
                    <li><a class="dropdown-item" href="<?= base_url('feed') ?>">Home 
                    ...
                    <li><a class="dropdown-item" href="<?= base_url('receita/cadastrar') ?>">Cadastrar receita 
                    ...
                    <li><a class="dropdown-item" href="<?= base_url('perfil') ?>">Acessar perfil
                    ...
                    <li><a class="dropdown-item" href="<?= base_url('receitasSalvas') ?>">Acessar salvos
                    ...
                    <li><a class="dropdown-item item-danger" href="<?= base_url('logout') ?>">Fazer logout
